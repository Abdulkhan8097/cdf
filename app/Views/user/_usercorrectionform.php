<div class="modal fade bs-example-modal-lg " id="correctionfileupload" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myLargeModalLabel">Upload Correction Files</h5>
                    ...
                    <div >
                            <div class="card-body">
                                ...
                                <div id="orderformdata" class="col-lg-12" >
                                   <form action="javascript:void(0);"  method="post" id="correctionform" " >
                                           ...
                                           <div class="col-lg-3  mt  float-left" >
                                            ...
                                            <div class="" style="min-height:200px">
                                                ...
                                                <div>
                                                    ...
                                                    <div class=" w-75 ml-4 mt-4 " style="max-height: 73px;">
                                                        ...
                                                        <div style="display:none" id='file_loader_div'>
                                                            ...
                                                            <h4 id='current_file_name' class="text-dark"></h4>
                                                        </div>
                                                        ...
                                                        <div style="display:none" id='overall_loader_div' class="mt-4">
                                                            ...
                                                            <h4 id='overall_file_count' class="text-dark"></h4>
                                                        </div>
                                                        ...
                                                        <div id='divsuccess' class="text-dark font-size-24"></div>
                                                    </div>
...
<script src="<?php echo base_url('js/customefileupload.js'); ?>"></script>
    ...
    $(document).ready(function() {
        ...
        inputField.on('change', (event) => {
            ...
            var curordernumber = $("#txtordernumber").val();
            ...
            if (files.length > 0) {
                ...
                for (i = 0; i < fileList.length; i++) {
                    ...
                    if (fileallow > -1) {
                        ...
                        if (filesize > 0) {
                            ...
                            //file it will take folder name and file
              ...
              //  console.log(largefiles);
                ...
                if (fileserrors) {
                    ...
                    //assign order number
                  //  customeupload.addordernumber("R-21-09-0015", "signlefolder");
                    customeupload.addordernumber(curordernumber, "signlefolder");
                    uploadajax();
...
//       { alert("od"+ordernumber)
//         customeupload.addordernumber(ordernumber, "signlefolder");
//       }
...
//                    }
       ...
       // async function start_upload(fileobject, filename, newordernumber) {
         function start_upload(fileobject, filename, newordernumber) {
            ...
            form_data.append('correctionfilestatus', "1");
