...
class certificates_image extends Model{
    
     protected $table = 'certificates_image';
     protected $primaryKey = 'id';
     protected $allowedFields = ['id', 'certificates_id', 'certificates_image', 'c_thumbnail'];
	...
	public function getData($searchArray=array(), $offset='', $limit='',$coutOnly='')
    {
        ...
        {
            $sql .= " AND  ad.certificates_id =".$searchArray['id'];
        }
...
//   echo $sql;die;
    ...
    public function get_user($id) {
     ...
     public function getfiledata($id){
        ...
        return $this->db
                        ->table('certificates_image')
                        ->where(["certificates_id" => $id])
                        ->get()
                        ->getResult();
    }
