            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <div class="float-right d-none d-md-block">
                        <div class="dropdown">
                            <a class="btn btn-primary waves-effect waves-light" href="<?php echo site_url('addvolunteer'); ?>">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    ...
                                    <a href="<?php echo site_url('viewvolunteer');?>"><button type="button" class="btn btn-primary waves-effect waves-light mr-1"
                                ...
                                <table  data-toggle="table" data-striped="true" class="table table-hover table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center"scope="row"><?php echo $kdata->volunteer_name ?></th>
                                            <th class="text-center"scope="row"><?php echo $kdata->volunteer_email?></th>
                                            ...
                                            <td class="text-center"width="8%">
                                                 <a title="View Details"href="<?php echo site_url('previewvolunteer?id=' . $kdata->volunteer_id) ?>" class="btn btn-primary btn-sm" title="Details"><i class="fas fa-eye" ></i></a>

                                            

                                                  <a href="<?php echo site_url('addvolunteer?id=' . $kdata->volunteer_id) ?>" title="Edit" class="btn btn btn-info btn-sm"><i class="fas fa-edit" style="padding-right: 0;"></i></a>

                                                  <a href="<?php echo site_url('Volunteer/delete?id=' . $kdata->volunteer_id) ?>" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure?')"><i class="fa fa-trash" style="padding-right: 0;"></i></a>
